...
python3 scripts/generate_length_parameter_curves_shac.py
...
python3 scripts/generate_length_parameter_curves_ppo.py
...
python3 scripts/generate_length_parameter_curves_sac.py
