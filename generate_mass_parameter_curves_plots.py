...
def plot_means_and_stds(means_list, stds_list, timesteps_list, series_list):
    ...
    plt.title("Pendulum Mass Robustness Comparison", fontsize=20, fontweight="bold")
    plt.xlabel(f"Pendulum mass (kg)", fontsize=14)
    ...
    plt.show()
    plt.savefig(
        "experiments/mass_parameter_curves/Mass Robustness Comparison.png", format="png"
    )
    plt.savefig(
        "experiments/mass_parameter_curves/Mass Robustness Comparison.svg", format="svg"
    )


model = "SHAC"
shac_run_dir = "experiments/mass_parameter_curves/SHAC"
ppo_run_dir = "experiments/mass_parameter_curves/PPO"
sac_run_dir = "experiments/mass_parameter_curves/SAC"
