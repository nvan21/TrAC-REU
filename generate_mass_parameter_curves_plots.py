...
def plot_means_and_stds(
    ...
    plt.title("Pendulum Mass Robustness Comparison", font=title_font, fontsize=40)
    plt.xlabel(f"Pendulum masses (kg)")
    plt.ylabel("Reward")
    ...
    # plt.tight_layout()
    plt.savefig(
        "experiments/mass_parameter_curves/Mass Robustness Comparison.png",
        format="png",
    )
    plt.savefig(
        "experiments/mass_parameter_curves/Mass Robustness Comparison.svg",
        format="svg",
    )
